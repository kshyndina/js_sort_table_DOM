...
const sorting = (x)=>{
    ...
    switch(x){
        ...
        case 4:
            return rows.sort((a, b)=>{
                return turnNumber(a.children[3].innerText) - turnNumber(b.children[3].innerText);
            });
    }
};
for(let i = 0; i < headers.length; i++)headers[i].addEventListener("click", ()=>body.prepend(...sorting(i + 1)));
